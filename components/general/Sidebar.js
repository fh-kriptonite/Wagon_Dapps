                ...
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                    ...
                    <div id="dropdown-cta" className="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
                        <div className="flex items-center mb-3">
                            <span className="bg-orange-100 text-orange-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-900">Testnet</span>
                        </div>
                        <p className="mb-3 text-sm text-blue-800 dark:text-blue-400">
                            Wagon Staking Platform! Claim your wagon token daily from the faucet and stake your wagon to your selected pool.
                        </p>
                    </div>
                </div>
            </aside>
