...
export default function LendToPoolFiatDialog(props) {
  ...
  function getStable() {
    if(stableNumber == "") return 0;
    return parseFloat(stableNumber)
  }
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 border rounded-xl p-4">
                    ...
                    <div className='flex gap-2 items-center justify-between mt-2 text-center'>
                      ...
                      <p className="text-xs font-semibold">
                          {numberWithCommas(getStable() , 2)} {symbol}
                      </p>
                    </div>
                    ...
                    <div className='flex gap-2 items-center justify-between mt-1 text-center'>
                      <p className="text-xs text-gray-500">
                          Total WAG
                          <span className="text-xs font-semibold"> ( {numberWithCommas(wagNumber , 2)} ) WAG</span>
                      </p>
                      <p className="text-xs font-semibold">
                      {numberWithCommas(0, 2)} {symbol}
                      </p>
                    </div>

                    <div className='flex gap-2 items-center justify-between text-center mt-1'>
                      <p className="text-xs text-gray-500">
                        Admin Fee
                      </p>
                      <p className="text-xs font-semibold">
