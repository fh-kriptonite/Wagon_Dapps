        ...
        <>
            {
                ...
                : <div className='card !p-0 overflow-hidden'>
                    {
                        (pool.contract.network == "offchain") &&
                    ...
                    <div className="p-4 md:p-6 space-y-6">
                        ...
                        <div className='flex flex-col md:flex-row items-start gap-4 md:gap-6'>
                            ...
                            <div className='flex flex-col gap-3 md:gap-4 flex-1'>
                                <div className="space-y-1">
                                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900">{pool.detail.name}</h2>
                                    <h5 className="text-sm md:text-base italic text-gray-500">{pool.detail.sub_name}</h5>
                                </div>
                                ...
                                <div className='flex flex-wrap gap-2'>
                                    {
                                        ...
                                        : <div className="flex gap-2">
                                            ...
                                            <img src={pool.detail.currency_logo} className="h-8 md:h-10" alt="Stable coin Logo" />  
                                        </div>
                                    }
                                    ...
                                    <div className='flex items-center gap-1.5 bg-blue-50 px-3 py-1.5 rounded-lg border border-blue-100'>
                                        ...
                                        <p className='text-xs font-medium text-blue-700'>Secured <span className='font-semibold'>{pool.detail.type}</span></p>
                                    </div>
                                </div>
                        ...
                        <div className="prose prose-sm md:prose-base max-w-none space-y-2">
                            <MarkdownComponent content={pool.detail.description} />
                        </div>

                        {/* Highlights Grid */}
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            {
                                pool.highlights.map((highlight: any, index: number) => (
                                    <div 
