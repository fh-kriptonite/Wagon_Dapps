...
const nextConfig = {
  ...
  env: {
    ...
    // BNB
    WAG_ADDRESS_BNB: process.env.WAG_ADDRESS_BNB_TESTNET,
    BNB_CHAIN_ID: process.env.BNB_CHAIN_ID_TESTNET,
    ERC1155_ADDRESS_BNB: process.env.ERC1155_ADDRESS_BNB_TESTNET,
    LENDING_ADDRESS_BNB: process.env.LENDING_ADDRESS_BNB_TESTNET,
    BNB_STABLE_COIN_ADDRESS_1: process.env.BNB_STABLE_COIN_ADDRESS_1,
    PROVIDER_HTTPS_BNB: process.env.PROVIDER_HTTPS_BNB_TESTNET,
